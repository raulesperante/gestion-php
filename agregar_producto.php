    ...
    <body>
        ...
        <br><h1 align="center">GESTIÓN DE PRODUCTOS</h1>     
            ...
            <div class="formulario">
                <form name="registro" method="post" action="logicaAgregarProductos.php" enctype="application/x-www-form-urlencoded">
                    <div class="campo">
                    ...
                    {
                        echo "<div>
                                <p>Ya existe un producto asociado al
                                código ingresado, inténtelo nuevamente</p>
                              </div>";
                    }
                    ?>
